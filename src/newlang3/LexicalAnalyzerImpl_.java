...
public class LexicalAnalyzerImpl_ implements LexicalAnalyzer {
    ...
    public LexicalAnalyzerImpl_(String filename) {
    ...
    public LexicalAnalyzerImpl_(FileInputStream fin){
        try {
            InputStream in = fin;
            this.isr = new InputStreamReader(in);
            this.pbr = new PushbackReader(isr);
